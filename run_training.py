...
op_num = 5  # Number of collective variables you want to learn + 1
konw_op_num = 0
...
trainer = Trainer(
    ...
    folder = 'traj_REST2',                        # folder of trajectories
    system = 'training_data',  # name of the trajectory, the file {system}_traj.npy will be used as the training set
