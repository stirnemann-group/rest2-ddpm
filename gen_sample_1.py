...
num_sample = 2000000 #total number of samples
model_id = 31
trainer.load(model_id) 

batch_size = 1280  #the number of samples generated in each batch
sample_ds = Dataset_traj('traj_REST2', 'sample_reweighted_energy_lambda_1') 
...
np.save(str(trainer.RESULTS_FOLDER / f'samples-{model_id}_1'), all_ops.numpy())
print(str(trainer.RESULTS_FOLDER / f'samples-{model_id}_1.npy'))
